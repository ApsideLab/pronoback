...
@Mapper
public interface HistoRankingEntityMapper {

    HistoRankingEntityMapper INSTANCE = Mappers.getMapper(HistoRankingEntityMapper.class);
    ...
    HistoRankingEntity mapHistoRankingEntity(HistoRanking histoRanking);
}
