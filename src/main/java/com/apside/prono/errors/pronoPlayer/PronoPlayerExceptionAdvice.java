...
@ControllerAdvice
public class PronoPlayerExceptionAdvice {
    ...
    @ExceptionHandler(BadRequestCreatePronoPlayerException.class)
    public final ResponseEntity<ApiError> handlePronoPlayerAlreadyExistException(BadRequestCreatePronoPlayerException ex, WebRequest request) {
