package com.apside.prono.errors.evenement;
...
@ControllerAdvice
public class EvenementExceptionAdvice {
    ...
    @ExceptionHandler(BadRequestCreateEvenementException.class)
    public final ResponseEntity<ApiError> handleEvenementAlreadyExistException(BadRequestCreateEvenementException ex, WebRequest request) {
