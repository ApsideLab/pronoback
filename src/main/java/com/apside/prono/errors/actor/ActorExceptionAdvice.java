...
@ControllerAdvice
public class ActorExceptionAdvice {
    ...
    @ExceptionHandler(BadRequestCreateActorException.class)
    public final ResponseEntity<ApiError> handleActorAlreadyExistException(BadRequestCreateActorException ex, WebRequest request) {
