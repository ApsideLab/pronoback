...
@ControllerAdvice
public class TypeEventLinkExceptionAdvice {
    ...
    @ExceptionHandler(BadRequestCreateTypeEventLinkException.class)
    public final ResponseEntity<ApiError> handleTypeEventLinkAlreadyExistException(BadRequestCreateTypeEventLinkException ex, WebRequest request) {
