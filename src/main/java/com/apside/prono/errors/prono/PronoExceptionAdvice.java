...
@ControllerAdvice
public class PronoExceptionAdvice {
    ...
    @ExceptionHandler(BadRequestCreatePronoException.class)
    public final ResponseEntity<ApiError> handlePronoAlreadyExistException(BadRequestCreatePronoException ex, WebRequest request) {
