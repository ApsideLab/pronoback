...
@ControllerAdvice
public class ResultEventExceptionAdvice {
    ...
    @ExceptionHandler(BadRequestCreateResultEventException.class)
    public final ResponseEntity<ApiError> handleResultEventAlreadyExistException(BadRequestCreateResultEventException ex, WebRequest request) {
