package com.apside.prono.errors.histoCalculs;
...
@ControllerAdvice
public class HistoCalculsExceptionAdvice {
    ...
    @ExceptionHandler(BadRequestCreateHistoCalculsException.class)
    public final ResponseEntity<ApiError> handleHistoCalculsAlreadyExistException(BadRequestCreateHistoCalculsException ex, WebRequest request) {
