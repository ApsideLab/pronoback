...
@ControllerAdvice
public class ActorLinkEventExceptionAdvice {
    ...
    @ExceptionHandler(BadRequestCreateActorLinkEventException.class)
    public final ResponseEntity<ApiError> handleActorLinkEventAlreadyExistException(BadRequestCreateActorLinkEventException ex, WebRequest request) {
