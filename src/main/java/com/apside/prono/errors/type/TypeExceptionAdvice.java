...
@ControllerAdvice
public class TypeExceptionAdvice {
    ...
    @ExceptionHandler(BadRequestCreateTypeException.class)
    public final ResponseEntity<ApiError> handleTypeAlreadyExistException(BadRequestCreateTypeException ex, WebRequest request) {
