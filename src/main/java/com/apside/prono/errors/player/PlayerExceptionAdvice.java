...
public class PlayerExceptionAdvice {
    ...
    @ExceptionHandler(BadRequestCreatePlayerException.class)
    public final ResponseEntity<ApiError> handleActorAlreadyExistException(BadRequestCreatePlayerException ex, WebRequest request) {
