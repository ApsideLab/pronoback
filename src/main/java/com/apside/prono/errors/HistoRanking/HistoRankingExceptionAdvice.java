...
@ControllerAdvice
public class HistoRankingExceptionAdvice {
    ...
    @ExceptionHandler(BadRequestCreateHistoRankingException.class)
    public final ResponseEntity<ApiError> handleHistoRankingAlreadyExistException(BadRequestCreateHistoRankingException ex, WebRequest request) {
