...
@ControllerAdvice
public class ContestExceptionAdvice {
    ...
    @ExceptionHandler(BadRequestCreateContestException.class)
    public final ResponseEntity<ApiError> handleContestAlreadyExistException(BadRequestCreateContestException ex, WebRequest request) {
