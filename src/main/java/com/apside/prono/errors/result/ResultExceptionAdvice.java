...
public class ResultExceptionAdvice {
    ...
    @ExceptionHandler(BadRequestCreateResultException.class)
    public final ResponseEntity<ApiError> handleResultAlreadyExistException(BadRequestCreateResultException ex, WebRequest request) {
