...
@ControllerAdvice
public class ResultTryRugbyExceptionAdvice {
    ...
    @ExceptionHandler(BadRequestCreateResultTryRugbyException.class)
    public final ResponseEntity<ApiError> handleEvenementAlreadyExistException(BadRequestCreateResultTryRugbyException ex, WebRequest request) {
